...
<div class="main_container">
  ...
  <div style="display:flex; font-size:0.7em; padding-left:20%;" class="signup">Already have an account?<a style="padding:0 8px;" class="nav-link" href="login.php">Login</a></div>
  </div>
</div>
</div>
    <footer>
